...
public abstract class FoodOrder {
    ...
    private static String restaurantName = "Online Food Express";
    ...
    public static void setRestaurantName(String restaurantName) { FoodOrder.restaurantName = restaurantName; }
